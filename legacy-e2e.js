...
const getMainAppPath = (__angularVersion) => {
...
const getMainLibSrcPath = (__angularVersion) => {
...
const copyFromMainPaths = (__angularVersion) => {
    ...
    const mainAppPath = getMainAppPath(__angularVersion);
    const libSrcPath = getLibSrcPath(__angularVersion);
    const mainLibSrcPath = getMainLibSrcPath(__angularVersion);
